...
echo "[-------------------------------------------------]
\e[33mაირჩიე დისკი რომლის აღდგენაც გინდა. მაგალითად როგორც:\e[0m"
echo "[-------------------------------------------------]" &&
...
4) echo "შენიშვნა! მე შეიძლება აღარ გავაგრძელო მისი განახლება და ტყუილად გადმოწეროთ ერთიდაიგივე კოდი.." && 
sleep 3 && 
